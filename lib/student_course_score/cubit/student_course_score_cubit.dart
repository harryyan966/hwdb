...
part 'student_course_score_state.dart';

class StudentCourseScoreCubit extends Cubit<StudentCourseScoreState> {
  StudentCourseScoreCubit({
    required HwdbHttpClient httpClient,
    required this.courseInfo,
    required this.student,
  })  : _httpClient = httpClient,
        super(const StudentCourseScoreState());
